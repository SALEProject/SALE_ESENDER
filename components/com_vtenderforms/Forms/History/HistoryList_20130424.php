<?php
	...
	try {				
		echo '<form name="input" action="index.php?option=com_vtenderforms&action=mylist&Itemid=120" method="post">';	
			...
			echo '&nbsp;<input type="text" id="datepickerFrom" name="datepickerFrom" value="' . $dateFrom->format('m/d/Y') . '"/>&nbsp;';
			echo '&nbsp;<input type="text" id="datepickerTo" name="datepickerTo" value="' . $dateTo->format('m/d/Y') . '"/>&nbsp;';
