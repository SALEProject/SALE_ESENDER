	...
	$platformSQLS =  array(
		...
		"SAVEDB"=>array(
			...
			"6"=>array(
				...
				"SQLType"=> "1",
				"SQL"	 => "select s.ID, s.XML_Path, f.Name, fn.RO, s.Form_Date, f.Description, s.ID_Language, l.Code as Language, s.ID_Header1, l1.Code as Language1, s1.ID_Language as ID_Language1, s.JOUEReady, s.JOUE_NO_DOC_EXT
